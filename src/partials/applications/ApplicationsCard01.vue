      ...
      <div class="grow flex flex-col p-5">
        ...
        <div class="grow">
          ...
          <div class="flex items-center space-x-2 mb-4">
            ...
            <!-- Rate -->
            <div class="inline-flex text-sm font-medium bg-amber-100 dark:bg-amber-400/30 text-amber-600 dark:text-amber-400 rounded-full text-center px-2.5 py-0.5">{{item.rating}}</div>
          </div>
          <!-- Features list -->
        ...
        <!-- Card footer -->
        <div>
          <router-link class="btn-sm w-full bg-jh-red-600 hover:bg-jh-red-700 text-white" :to="item.link">Install</router-link>
        </div>
      </div>
    </div>
  </div>
