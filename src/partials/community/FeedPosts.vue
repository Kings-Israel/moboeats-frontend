<template>
      ...
      <div class="relative !my-4">
        ...
        <div class="absolute left-0 right-0 bottom-0 p-4 bg-black bg-opacity-25 backdrop-blur-md">
          <div class="flex items-center justify-between">
            ...
            <a class="text-xs font-medium text-jh-red-400 hover:text-jh-red-300" href="#0">Learn More -&gt;</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <li class="p-3 bg-slate-50 dark:bg-slate-900/30 rounded">
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <div class="text-sm"><a class="font-medium text-jh-red-600 hover:text-jh-red-700 dark:hover:text-jh-red-400" href="#0">@EricaSpriggs</a> Reading through and really enjoying "Zero to Sold" by Arvid.</div>
            </div>
          </div>
        </li>
        <!-- Comment -->
  ...
  <div class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    ...
    <footer class="flex items-center space-x-4">
      <!-- Like button -->
      <button class="flex items-center text-jh-red-400 dark:text-jh-red-600">
        <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
          <path d="M14.682 2.318A4.485 4.485 0 0011.5 1 4.377 4.377 0 008 2.707 4.383 4.383 0 004.5 1a4.5 4.5 0 00-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 000-6.364zm-1.4 4.933L8 12.247l-5.285-5A2.5 2.5 0 014.5 3c1.437 0 2.312.681 3.5 2.625C9.187 3.681 10.062 3 11.5 3a2.5 2.5 0 011.785 4.251h-.003z" />
        </svg>
        <div class="text-sm text-jh-red-600">2.2K</div>
      </button>
      <!-- Share button -->
      <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-jh-red-600 dark:hover:text-jh-red-600">
        <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
