      ...
      <div class="-mt-16 mb-6 sm:mb-3">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
          ...
          <div class="flex space-x-2 sm:mb-2">
            ...
            <button class="btn-sm bg-jh-red-600 hover:bg-jh-red-700 text-white">
      ...
      <header class="text-center sm:text-left mb-6">
        ...
        <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
          ...
          <div class="flex items-center">
            ...
            <a class="text-sm font-medium whitespace-nowrap text-jh-red-600 hover:text-jh-red-700 dark:hover:text-jh-red-400 ml-2" href="#0">carolinmcneail.com</a>
          </div>
        </div>
      </header>
      ...
      <div class="relative mb-6">
        ...
        <ul class="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
          <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <a class="block pb-3 text-jh-red-600 whitespace-nowrap border-b-2 border-jh-red-600" href="#0">General</a>
          </li>
          <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            ...
            <div class="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
              <ul class="space-y-3">
                ...
                <li class="sm:flex sm:items-center sm:justify-between">
                  <div class="sm:grow flex items-center text-sm">
                    <!-- Icon -->
                    <div class="w-8 h-8 rounded-full shrink-0 bg-jh-red-600 my-2 mr-3">
