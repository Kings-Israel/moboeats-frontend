      ...
      <div class="md:py-8">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-slate-50 dark:bg-slate-800/20 p-4 rounded border border-slate-200 dark:border-slate-700">
            ...
            <div class="mt-4">
              <button class="btn-sm w-full bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-jh-red-600 shadow-none">Follow</button>
            </div>
          </div>
