<template>
  <div class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
    ...
    <div class="mb-3">
      ...
      <div class="flex items-center mb-2">
        <div class="flex shrink-0 -space-x-3 -ml-px mr-2">
          <a class="block" href="#0">
            <img class="rounded-full border-2 border-white dark:border-slate-800 box-content" src="../../images/user-28-12.jpg" width="28" height="28" alt="User 12" />
          </a>
        </div>
        <div class="grow">
      ...
      <!-- Content -->
      <div>
        <div class="text-sm">Dedicated form for a category of users that will perform actions? <a class="font-medium text-jh-red-600 hover:text-jh-red-700 dark:hover:text-jh-red-400" href="#0">#viewall</a></div>
      </div>
    </div>
    <!-- Footer -->
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <!-- Like button -->
        <button class="flex items-center text-slate-400 dark:text-slate-500 hover:text-jh-red-600  dark:hover:text-jh-red-600 ml-3">
        ...
        <!-- Attach button -->
        <button class="text-slate-400 dark:text-slate-500 hover:text-jh-red-600  dark:hover:text-jh-red-600 ml-3">
          <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
