              ...
              <td class="p-2">
                <div class="flex items-center">
                  ...
                  <router-link
                    ...
                    class="text-slate-800 dark:text-slate-100 hover:text-slate-200"
              ...
              <td class="p-2">
                <router-link
                  :to="{
                    name: 'order-details',
                    params: {
                      id: restaurant.orders[restaurant.orders.length - 1].uuid,
                    },
                  }"
                  class="text-left text-emerald-500 hover:text-emerald-400"
                  >{{ getLatestOrder(restaurant) }}</router-link
                >
              </td>
              <td class="p-2">
                <div class="text-left text-sky-500">
