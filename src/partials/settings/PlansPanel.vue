<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
      ...
      <section>
        ...
        <div>
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            <!-- Tab 3 -->
            <div class="relative col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-md rounded-sm border border-slate-200 dark:border-slate-700">
              <div class="absolute top-0 left-0 right-0 h-0.5 bg-jh-red-600" aria-hidden="true"></div>
              <div class="px-5 pt-5 pb-6 border-b border-slate-200 dark:border-slate-700">
                <header class="flex items-center mb-2">
                ...
                <!-- CTA -->
                <button class="btn bg-jh-red-600 hover:bg-jh-red-700 text-white w-full">Upgrade</button>
              </div>
              <div class="px-5 pt-4 pb-5">
                <div class="text-xs text-slate-800 dark:text-slate-100 font-semibold uppercase mb-4">What's included</div>
                <!-- List -->
      ...
      <!-- Contact Sales -->
      <section>
        <div class="px-5 py-3 bg-indigo-50 dark:bg-jh-red-600/30 border border-indigo-100 dark:border-transparent rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
          <div class="text-slate-800 dark:text-slate-100 font-semibold mb-2 xl:mb-0">Looking for different configurations?</div>
          <button class="btn bg-jh-red-600 hover:bg-jh-red-700 text-white">Contact Sales</button>
        </div>
      </section>
      ...
      <section>
        ...
        <ul class="space-y-5">
          ...
          <li>
            ...
            <div class="text-sm">
              Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat <a class="font-medium text-jh-red-600 hover:text-jh-red-700 dark:hover:text-jh-red-400" href="#0">contact us</a>.
            </div>
          </li>
        </ul>
      </section>
