<template>
  <div class="min-w-fit">
    ...
    <div class="fixed inset-0 bg-[#001510] bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200" :class="sidebarOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'" aria-hidden="true"></div>

    <!-- Sidebar -->
    <div
      id="sidebar"
      ref="sidebar"
      class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-[#001510] p-4 transition-all duration-200 ease-in-out"
    ...
    >
      ...
      <div class="flex justify-between lg:justify-center mb-10 pr-3 sm:px-2">
        ...
        <router-link class="flex gap-4" to="/">
          <img src="../images/mobo-logo.jpeg" class="w-24 h-28 mx-auto object-contain" alt="">
        </router-link>
      </div>
