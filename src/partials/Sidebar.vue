      ...
      <div class="space-y-8">
        ...
        <div>
          <ul class="mt-1">
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  @click="navigate"
                >
                  <span class="text-sm font-medium">Branch Admins</span>
                </a>
              </div>
            </router-link>
            <!-- Riders -->
            <router-link
              v-if="permissions.includes('view riders')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/riders"
            >
            ...
            <!-- Orphanages -->
            <router-link
              v-if="permissions.includes('view orphanages')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/orphanages"
            >
              ...
              >
                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  <path
                    class="fill-current"
                    :class="
                      currentRoute.fullPath.includes('orphanages')
                        ? 'text-yellow-600'
                        : 'text-yellow-700'
                    "
            ...
            <!-- Orders -->
            <router-link
              v-if="permissions.includes('view orders')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/orders"
            >
            ...
            <!-- Payments -->
            <router-link
              v-if="permissions.includes('view payments')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/payments"
            >
            ...
            <SidebarLinkGroup
              v-if="
                permissions.includes('view riders payouts') ||
                permissions.includes('view partners payouts')
              "
              v-slot="parentLink"
            ...
            >
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  <!-- Diet Subscribers -->
                  <router-link
                    v-if="permissions.includes('view riders payouts')"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                    to="/payouts/riders"
                  >
                  ...
                  <router-link
                    v-if="permissions.includes('view partners payouts')"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                    to="/payouts/partners"
                  >
            ...
            <SidebarLinkGroup
              v-if="
                permissions.includes('view diet plan subscriptions') ||
                permissions.includes('view diet plan packages') ||
                permissions.includes('add/edit diet plan packages')
              "
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('diet')"
            >
              <a
                class="block text-slate-200 truncate transition duration-150"
                :class="
                  currentRoute.fullPath.includes('diet')
                    ? 'hover:text-slate-200'
                    : 'hover:text-white'
                "
                href="#0"
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  <!-- Diet Subscribers -->
                  <router-link
                    v-if="permissions.includes('view diet plan subscriptions')"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                    to="/diet/subscribers"
                  >
            ...
            <SidebarLinkGroup
              class="hidden"
              v-if="
                permissions.includes('view supplements') ||
                permissions.includes('add/edit supplements') ||
                permissions.includes('view suppliers') ||
                permissions.includes('view supplements orders') ||
                permissions.includes('edit supplements orders')
              "
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('supplements')"
            >
              <a
                class="block text-slate-200 truncate transition duration-150"
                :class="
                  currentRoute.fullPath.includes('supplements')
                    ? 'hover:text-slate-200'
                    : 'hover:text-white'
                "
                href="#0"
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  ...
                  <router-link
                    v-if="
                      permissions.includes('view suppliers') ||
                      permissions.includes('add/edit suppliers')
                    "
                    to="/supplements/suppliers"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
                    <li class="mb-1 last:mb-0">
            ...
            <!-- Discounts -->
            <router-link
              v-if="permissions.includes('view discounts')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/discounts"
            >
              ...
              >
                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  <path
                    class="fill-current"
                    :class="
                      currentRoute.fullPath.includes('discounts')
                        ? 'text-yellow-600'
                        : 'text-yellow-700'
                    "
                    d="M4.418 19.612A9.092 9.092 0 0 1 2.59 17.03L.475 19.14c-.848.85-.536 2.395.743 3.673a4.413 4.413 0 0 0 1.677 1.082c.253.086.519.131.787.135.45.011.886-.16 1.208-.474L7 21.44a8.962 8.962 0 0 1-2.582-1.828Z"
            ...
            <router-link
              v-if="
                permissions.includes('view frequently asked questions') ||
                permissions.includes('add/edit frequently asked questions')
              "
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/faqs"
            ...
            <!-- Logs -->
            <router-link
              v-if="permissions.includes('view logs')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/logs"
            >
            ...
            <!-- Countries -->
            <router-link
              v-if="permissions.includes('view countries')"
              custom
              v-slot="{ href, navigate, isExactActive }"
              to="/countries"
            >
            ...
            >
              <li
                class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 hidden"
