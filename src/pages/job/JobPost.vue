      ...
      <main class="grow">
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              <div class="mb-6">
                <router-link class="btn-sm px-3 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" to="/job/job-listing">
              ...
              <div class="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 mb-6 lg:hidden">
                ...
                <div class="space-y-2 sm:flex sm:space-y-0 sm:space-x-2">
                  <button class="btn w-full bg-jh-red-600 hover:bg-jh-red-700 text-white">Apply Today -&gt;</button>
              ...
              <div class="mb-6">
                <div class="flex flex-wrap items-center -m-1">
                  <div class="m-1">
                    <a class="text-xs inline-flex font-medium bg-jh-red-50 dark:bg-jh-red-600/30 text-jh-red-700 dark:text-jh-red-400 rounded-full text-center px-2.5 py-1" href="#0">Full-time</a>
                  </div>
                  <div class="m-1">
                    <a class="text-xs inline-flex font-medium bg-jh-red-50 dark:bg-jh-red-600/30 text-jh-red-700 dark:text-jh-red-400 rounded-full text-center px-2.5 py-1" href="#0">Senior Engineer</a>
                  </div>
                  <div class="m-1">
                    <a class="text-xs inline-flex font-medium bg-jh-red-50 dark:bg-jh-red-600/30 text-jh-red-700 dark:text-jh-red-400 rounded-full text-center px-2.5 py-1" href="#0">Remote</a>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-6">
                ...
                <div class="flex justify-between items-center">
                  <!-- Apply button -->
                  <button class="btn bg-jh-red-600 hover:bg-jh-red-700 text-white whitespace-nowrap">Apply Today -&gt;</button>
                  <!-- Share -->
