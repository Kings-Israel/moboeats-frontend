  ...
  <div class="flex h-[100dvh] overflow-hidden">
    ...
    >
      ...
      <main class="grow" v-if="restaurant != null">
        <div
          v-if="restaurant.operating_hours.length == 0"
          class="relative bg-red-200 dark:bg-red-500 p-4 sm:p-6 rounded-sm overflow-hidden mb-8"
        >
          ...
          <div class="relative">
            <h1
              class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-1"
            >
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0 flex gap-2">
              ...
              />
              <h1
                class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold my-auto"
              >
                {{ restaurant.name }} ✨
              </h1>
            </div>
            <div class="flex gap-2 flex-wrap">
              <span
                v-if="
                  userPermissions('edit partners') &&
                  restaurant.status == 'Pending'
                "
                class="text-sm rounded-xl p-2 bg-slate-500 text-slate-200 mr-4"
                >Pending Approval</span
              >
              <button
                class="btn bg-yellow-400 text-white hover:bg-yellow-600 transition duration-200 ease-in-out"
                v-if="
                  userPermissions('edit partners') &&
              ...
              >
                <h1 class="text-lg text-slate-800 dark:text-slate-200">
                ...
                <textarea
                  ...
                  class="form-input bg-white dark:bg-slate-800 w-full"
                ></textarea>
              ...
              <modal-action
                v-if="userPermissions('edit partners')"
                :add-class="'max-w-lg'"
                :id="'addServiceChargeAgreement'"
                :modal-open="serviceChargeAgreementModal"
                @close-modal="serviceChargeAgreementModal = false"
              >
                <h1 class="text-lg text-slate-800 dark:text-slate-200">
                  Enter Service Charge Agreement
                </h1>
                <input
                  name="statusReason"
                  type="number"
                  id=""
                  v-model="serviceChargeAgreement"
                  class="form-input bg-white dark:bg-slate-800 w-full mb-2"
                />
                <div class="flex justify-end">
                  <button
                    class="btn bg-indigo-500 hover:bg-indigo-600 text-white"
              ...
              <modal-action
                v-if="userPermissions('edit partners')"
                :add-class="'max-w-lg'"
                :id="'addServiceChargeGroceriesAgreement'"
                :modal-open="serviceChargeGroceriesAgreementModal"
                @close-modal="serviceChargeGroceriesAgreementModal = false"
              >
                <h1 class="text-lg text-slate-800 dark:text-slate-200">
                  Enter Service Charge Agreement
                </h1>
                <input
                  ...
                  type="number"
                  id=""
                  v-model="serviceChargeGroceriesAgreement"
                  class="form-input bg-white dark:bg-slate-800 w-full mb-2"
                />
                <div class="flex justify-end">
                  <button
          ...
          <div class="flex gap-2 mb-2">
            ...
            >
              Groceries Service Charge Agreement ({{
                restaurant.groceries_service_charge_agreement
                  ? restaurant.groceries_service_charge_agreement
                  : 0
              }}%)
            </button>
            ...
            >
              Service Charge Agreement ({{
                restaurant.service_charge_agreement
                  ? restaurant.service_charge_agreement
                  : 0
              }}%)
            </button>
            <router-link
              :to="{ name: 'partner-edit', params: { id: restaurant.uuid } }"
            >
              <button class="btn bg-yellow-200 text-slate-800 font-bold">
                Edit
              </button>
            </router-link>
          </div>
          <div class="grid grid-cols-12 gap-6">
            <div class="col-span-full xl:col-span-4">
              <div
                class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 h-fit"
              >
                <header
                  class="px-5 py-2 border-b border-slate-100 dark:border-slate-700"
                >
                  <h2
                    class="font-semibold text-slate-800 dark:text-slate-100 underline"
                  >
                    Branch Info
                  </h2>
                </header>
                <div class="flex gap-2 p-3">
                  <div class="flex flex-col space-y-2 w-[98%]">
                    <h1
                      class="flex flex-wrap gap-2 font-bold text-slate-800 dark:text-slate-100"
                    >
                      <span>Email:</span
                      ><strong class="text-ellipsis overflow-hidden">{{
                        restaurant.email
                      }}</strong>
                    </h1>
                    <h1
                    ...
                    >
                      ...
                      ><strong class="text-ellipsis overflow-hidden">{{
                        moment(restaurant.created_at).format("Do MMM Y")
                      }}</strong>
                    </h1>
                  </div>
                </div>
            ...
            <div class="col-span-full xl:col-span-4">
              ...
              >
                ...
                <div class="flex gap-3 p-3">
                  <img
                    :src="
                      restaurant.user.image
                        ? restaurant.user.image
                        : '../../src/images/icon-01.svg'
                    "
                    :alt="restaurant.user.name"
                      ...
                      <div class="grow p-5">
                        <header class="space-y-2">
                          ...
                          <div class="flex justify-center items-center">
                            <span
                              class="text-2xl font-medium text-slate-400 -mt-0.5 mr-1"
                              >{{ restaurant.orders_count }}</span
                            >
                          </div>
                        </header>
                      </div>
                  ...
                  >
                    <div class="flex justify-between h-full mx-6 my-2">
                      ...
                      <div class="flex items-center space-x-2">
                        ...
                        <!-- Rate -->
                        <div class="inline-flex font-medium text-amber-600">
                          {{ averageRating }}
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="grow p-5">
                    <header>
                      <div class="flex justify-center mb-2">
                        <div
                          class="absolute top-0 right-0 -mr-2 bg-white dark:bg-slate-700 rounded-full shadow"
                          aria-hidden="true"
                          to="/users"
                        >
                          <svg
          ...
          <div class="grid grid-cols-2 gap-6">
            <div class="col-span-full xl:col-span-1">
              ...
              >
                <header
                  class="px-5 py-2 border-b border-slate-100 dark:border-slate-700 flex justify-between"
                >
                  <h2
                    class="font-semibold text-slate-800 dark:text-slate-100 underline"
                  >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  ...
                  <div class="overflow-x-auto">
                        ...
                        <tr v-for="order in orders" :key="order.id">
                          ...
                          >
                            <div class="text-left font-medium text-emerald-500">
                              {{
                                formatValue(order.total_amount, order.country)
                              }}
                            </div>
                          </td>
                          <td
                    ...
                    <div class="mt-8">
                      <PaginationClassic
                        @change-page="ordersChangePage"
                        :next_page="nextOrdersPageUrl"
                        :prev_page="prevOrdersPageUrl"
                        :from="ordersFrom"
                        :to="ordersTo"
                        :total_items="ordersTotalItems"
                      />
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  ...
                  <div class="overflow-x-auto">
                          ...
                          >
                            <div class="text-left font-medium text-emerald-500">
                              {{
                                formatValue(
                                  payment.amount,
                                  payment.orderable.user.country
                                )
                              }}
                            </div>
                          </td>
                    ...
                    <div class="mt-8">
                      <PaginationClassic
                        @change-page="paymentsChangePage"
                        :next_page="nextPaymentsPageUrl"
                        :prev_page="prevPaymentsPageUrl"
                        :from="paymentsFrom"
                        :to="paymentsTo"
                        :total_items="paymentsTotalItems"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            >
              ...
              <div class="p-3">
                ...
                <div class="overflow-x-auto relative">
                  <table class="table-auto w-full dark:text-slate-300">
                    ...
                    >
                      ...
                      <tr
                        ...
                        :key="menu_item.id"
                        :class="
                          menu_item.id === editMenuId
                            ? 'bg-slate-600 transition duration-200 ease-in-out'
                      ...
                      >
                        <td class="p-2">
                          <div class="flex items-center">
                            ...
                            >
                              <li
                                v-for="image in menu_item.images"
                                :key="image.id"
                              >
                                <img
                            ...
                            <div
                              class="text-slate-800 dark:text-slate-100 ml-2"
                            >
                              {{ menu_item.title }}
                            </div>
                          </div>
                        ...
                        <td class="p-2">
                          <div
                            :class="
                              menu_item.status == 2
                                ? 'text-green-500 font-semobold'
                                : 'text-red-500 font-semobold'
                            "
                          >
                            {{ menu_item.status == 2 ? "Active" : "Inactive" }}
                          </div>
                        </td>
                        <td class="p-2">
                          <div class="text-center text-sky-500">
                            {{ menu_item.order_items_count }}
                          </div>
                        </td>
                        <td class="p-2">
                          <div
                            v-if="menu_item.created_at"
                            class="text-center text-sky-500"
                          >
                            {{
                              moment(menu_item.created_at).format("Do MMM Y")
                            }}
                          </div>
                        </td>
                        <td class="p-2 flex justify-between">
                          ...
                          <button
                            class="btn btn-sm font-medium text-yellow-500 hover:text-yellow-600 dark:hover:text-yellow-400"
                            @click="editMenu(menu_item, 'edit images')"
                          >
                            {{
                              menu_item.images.length <= 0 ? "Add" : "Edit"
                            }}
                            Images
                            <span
                              v-if="menu_item.images.length <= 0"
                              class="w-2 h-2 bg-red-600 rounded-full my-auto ml-0.5"
                            ></span>
                          </button>
                          <button
                            class="btn btn-sm font-medium text-green-500 hover:text-green-600 dark:hover:text-green-400"
                            @click="editMenu(menu_item, 'edit prices')"
                          >
                            {{
                              menu_item.menu_prices.length <= 0 ? "Add" : "Edit"
                            }}
                            Prices
                            <span
                              v-if="menu_item.menu_prices.length <= 0"
                              class="w-2 h-2 bg-red-600 rounded-full my-auto ml-0.5"
                            ></span>
                          </button>
                        </td>
                  ...
                  <div class="mt-8">
                    <PaginationClassic
                      @change-page="menuChangePage"
                      :next_page="nextMenuPageUrl"
                      :prev_page="prevMenuPageUrl"
                      :from="menuFrom"
                      :to="menuTo"
                      :total_items="menuTotalItems"
                    />
            ...
            <div
              class="col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-md border border-slate-200 dark:border-slate-700 relative h-full"
            >
              <div class="p-3">
                <div class="flex justify-between mb-6">
                  ...
                  >
                    {{ action == "create menu" ? "Add" : "Update" }} Menu
                  </h1>
                  <button
                    v-if="action != 'create menu'"
                    class="btn btn-sm bg-slate-400 text-black"
                ...
                <!-- Add/Edit Menu -->
                <form
                  v-if="action == 'create menu' || action == 'edit menu'"
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        id=""
                        class="form-input w-full min-h-full rounded-lg"
                        rows="2"
                        v-model="addMenuDescription"
                      ></textarea>
                    </div>
                    <div>
                      <label
                      ...
                      <input
                        ...
                        type="number"
                        min="0"
                        v-model="addMenuPreparationTime"
                      />
                    </div>
                    <div>
                      <label
                ...
                <!-- Add/Edit Images -->
                <form
                  v-if="action == 'edit images'"
                  class="relative flex flex-col justify-between h-full"
                  @submit.prevent="createImages"
                >
                  <div
                    class="flex gap-2 w-fit max-h-[22rem] overflow-auto flex-wrap"
                  >
                    <img
                      class="w-40 h-40 rounded-lg object-cover mb-2"
                      v-for="image in currentMenuImages"
                      :key="image.id"
                      :src="image.image_url"
                      alt="menu"
                    />
                  ...
                  <div class="w-full">
                    <label
                      for="dropzone-file"
                      class="flex w-full h-16 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                    >
                      <div class="flex">
                        <p
                          v-if="addMenuImages.length == 0"
                          class="mb-2 text-sm px-6 my-5 text-gray-500 dark:text-gray-400"
                        >
                          <span class="font-semibold">Click to upload</span> or
                          drag and drop(Max 2 Files)
                        </p>
                        <div v-else class="flex flex-col flex-wrap">
                          <p
                            v-for="image in addMenuImages"
                            :key="image"
                            class="text-sm ml-2 whitespace-pre-wrap text-gray-500 dark:text-gray-400"
                          >
                ...
                <!-- Add/Edit Price -->
                <form
                  v-if="action == 'edit prices' || action == 'add price'"
                  class="relative flex flex-col justify-evenly"
                  @submit.prevent="createMenu"
                >
                  <div
                    class="flex gap-2 w-full max-h-[26rem] overflow-auto flex-wrap"
                  >
                    <div v-for="index in addPricesCount" :key="index">
                          ...
                          <div class="m-3">
                            ...
                            <label class="flex items-center">
                              <input
                                type="radio"
                                :name="index"
                                v-model="addPriceStatus[index - 1]"
                                value="2"
                                class="form-radio"
                              />
                              <span class="text-sm ml-2">Active</span>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          class="form-input w-full min-h-full rounded-lg"
                          rows="2"
                          v-model="addPriceDescriptions[index - 1]"
                        ></textarea>
                      </div>
                      <div
                        class="flex justify-between px-1"
                        v-if="action == 'edit prices'"
                      >
                        <button
                          class="btn btn-sm w-fit bg-red-500 text-white"
                          @click.prevent="removePrice(index - 1)"
                        >
                          Remove
                        </button>
                        <button
                          class="btn btn-sm w-fit bg-green-500 text-white"
                          @click.prevent="updatePrice(index - 1)"
                        >
                          Update
                        </button>
                      </div>
              ...
              <div class="p-3">
                ...
                <div class="overflow-x-auto relative">
                      ...
                      >
                        <td class="p-2">
                          <div class="flex items-center">
                            <img
                              :src="category.image"
                              alt=""
                              class="w-8 h-8 object-cover mx-2"
                            />
                        ...
                        <td class="p-2">
                          <div
                            ...
                            class="text-center text-sky-500"
                          >
                            {{ moment(category.created_at).format("Do MMM Y") }}
                          </div>
                        </td>
                        <td class="p-2">
                          <button
                  ...
                  <div class="mt-8">
                    ...
                    <PaginationNumeric
                      @change-page="categoriesChangePage"
                      :next_page="nextCategoriesPageUrl"
                      :prev_page="prevCategoriesPageUrl"
                      :from="categoriesFrom"
                      :to="categoriesTo"
                      :total_items="categoriesTotalItems"
                      :links="categoriesPagesLinks"
                    />
                  </div>
                </div>
              </div>
            ...
            <!-- Add Category Form -->
            <div
              class="col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-md border border-slate-200 dark:border-slate-700"
            >
              <div class="p-3">
                <h1
                  class="text-xl text-slate-800 dark:text-slate-100 font-bold mb-6"
                >
                  {{ category_action == "create" ? "Add" : "Edit" }} Category
                </h1>
                <!-- Form -->
                <form
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        v-on:change="selectCategoryImage"
                        id=""
                      />
                    </div>
                  </div>
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-full xl:col-span-1">
              ...
              >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  <div
                    v-for="time in restaurant.operating_hours"
                    :key="time.id"
                  >
                    <div class="grid grid-cols-3">
                      <span>{{ time.day }}</span>
          ...
          >
            <header
              class="py-2 border-b border-slate-100 dark:border-slate-700 flex justify-between"
            >
              <h2
                class="font-semibold text-slate-800 dark:text-slate-100 underline"
              >
  ...
  setup() {
    ...
    const baseURL =
      process.env.NODE_ENV === "development"
        ? "http://moboeats.test/"
        : "https://api.moboeats.co.uk/";

    const getMenu = () => {
      $http
        .get(`/admin/restaurant/${router.params.id}/menu`)
        .then((response) => {
          menu.value = [];
    ...
    const getRestaurant = () => {
      $http.get("/admin/restaurant/" + router.params.id).then((response) => {
        ...
        serviceChargeAgreement.value =
          restaurant.value.service_charge_agreement;
        serviceChargeGroceriesAgreement.value =
          restaurant.value.groceries_service_charge_agreement;
        center.value = {
          lat: Number(restaurant.value.latitude),
          lng: Number(restaurant.value.longitude),
        };
        marker.value.push({
          position: {
            lat: Number(restaurant.value.latitude),
    ...
    const updateServiceChargeAgreement = () => {
      $http
        .post(
          `/admin/restaurant/${restaurant.value.uuid}/update/service-charge-agreement`,
          {
    ...
    const getPayments = () => {
      $http
        .get("/admin/restaurant/" + router.params.id + "/payments")
        .then((response) => {
          payments.value = [];
    ...
    const getOrders = () => {
      $http
        .get("/admin/restaurant/" + router.params.id + "/orders")
        .then((response) => {
          orders.value = [];
    ...
    const getReviews = () => {
      $http
        .get("/admin/restaurants/" + router.params.id + "/reviews")
        .then((response) => {
    ...
    const getRestaurantCategories = () => {
      $http
        .get("/admin/restaurant/" + router.params.id + "/categories")
        .then((response) => {
          restaurantCategories.value = [];
          categoriesPagesLinks.value = [];
          restaurantCategories.value = response.data.data.categories.data;
          nextCategoriesPageUrl.value =
            response.data.data.categories.next_page_url;
          lastCategoriesPageUrl.value =
            response.data.data.categories.last_page_url;
          prevCategoriesPageUrl.value =
            response.data.data.categories.prev_page_url;
    ...
    watch(menuSearch, async (newSearch, oldSearch) => {
      $http
        .get(
          "/admin/restaurant/" + router.params.id + "/menu?search=" + newSearch
        )
        .then((response) => {
          menu.value = response.data.data.data;
          nextMenuPageUrl.value = response.data.data.next_page_url;
    ...
    const downloadFile = (file) => {
      $http
        .get(`/admin/documents/${file.id}/download`, {
        ...
        .then((response) => {
          ...
          fileLink.setAttribute("download", `${file.document_name}.pdf`);
    ...
    const updateStatus = (status) => {
      $http
        .post(`/admin/restaurants/${router.params.id}/status/update`, {
          status: status,
    ...
    const updatePrice = (index) => {
      ...
      $http
        .post(`/restaurant/menu-prices/${id}/update`, formData)
        .then(() => {
          getMenu();
    ...
    const createImages = () => {
      ...
      $http
        .post(`/restaurant/menu/${editMenuId.value}/images/update`, formData)
        .then(() => {
          getMenu();
      ...
      if (edit_action == "edit menu") {
        ...
        if (menu.categories.length > 0) {
          menu.categories.forEach((category) => {
            ...
            if (
              possible_groceries_names.includes(category.title.toLowerCase())
            ) {
    ...
    const removePrice = (index) => {
      if (addPricesCount.value > 1) {
        let id = currentPrices.value[index].id;
        $http.delete(`/restaurant/menu-prices/${id}/delete`).then(() => {
          addPricesCount.value -= 1;
    ...
    const createMenu = () => {
      switch (action.value) {
        case "create menu":
          $http
            .post(`/admin/restaurant/${router.params.id}/menu/add`, {
        ...
        case "edit menu":
          $http
            .post(`/admin/restaurant/menu/${editMenuId.value}/update`, {
              title: addMenuTitle.value,
              description: addMenuDescription.value,
              categoryIds: addMenuCategories.value,
              subcategoryIds: addMenuSubcategories.value,
        ...
        case "add price":
          ...
          $http
            .post("/restaurant/menu-prices", formData)
            .then(() => {
              getMenu();
    ...
    const addCategory = () => {
      ...
      if (category_action.value == "create") {
        $http
          .post("restaurant/" + router.params.id + "/categories/add", formData)
          .then(() => {
            getMenu();
            getRestaurantCategories();
