      ...
      <div ref="modalContent" class="bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li>
                <router-link class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-jh-red-600 rounded group" to="#0" @click="$emit('close-modal')">
